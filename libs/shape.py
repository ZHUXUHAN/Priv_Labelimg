...
DEFAULT_LINE_COLOR = QColor(255, 255, 0, 128)
...
class Shape(object):
    ...
    def __init__(self, label=None, shape_type=0, line_color=None, instance_id=0, ignore=0):
        self.label = label
    ...
    def paint(self, painter):
        ...
        if self.label is not None and self.shape_type == self.RECT_SHAPE:
            ...
            painter.drawText(self.points[2], str(self.ignore))
